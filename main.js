...
document.getElementById("sketch_to_be_draw").innerHTML="sketch_to_be_draw"+sketch ;
...
function updateCanvas(){
    ...
    random_number= Math.floor((Math.random()*quick_draw_data_set.length)+1)
sketch = quick_draw_data_set[random_number];
    document.getElementById("sketch_to_be_draw").innerHTML="sketch to be draw-"+sketch;
}
